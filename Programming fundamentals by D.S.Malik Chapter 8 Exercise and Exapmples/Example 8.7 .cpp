// Distance and average speed over time intervals
#include <iostream>
#include <iomanip>
using namespace std;
                                  ...
                                  double avgSpeed[])
{
    for (int index = 0; index < length - 1; index++)
        avgSpeed[index] = (list[index + 1] - list[index]) / 10.0;

    avgSpeed[length - 1] = 0.0;
}
...
{
    cout << setw(7) << "Time "
         << setw(20) << "Distance Traveled "
         << setw(25) << "Average Speed / Time Interval" << endl;
